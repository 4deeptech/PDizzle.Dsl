...
namespace FourDeep.PDizzle
{
    ...
    public class PropertyChangeRule : ChangeRule
    {
           ...
           (ModelElement modelElement)
        {
            ...
            if (property.AggregateRoot != null)
            {
                global::System.Collections.IEnumerable elements = new DslModeling::ModelElement[] { property.AggregateRoot };
                UpdateCompartments(elements, typeof(global::FourDeep.PDizzle.AggregateRootShape), "Properties", false);
            }
            ...
            if (property.DomainCommand != null)
            {
                ...
                UpdateCompartments(elements, typeof(global::FourDeep.PDizzle.DomainCommandShape), "Properties", false);
            }
            ...
            if (property.DomainEvent != null)
            {
                ...
                UpdateCompartments(elements, typeof(global::FourDeep.PDizzle.DomainEventShape), "Properties", false);
            }

            if (property.Entity != null)
            {
                global::System.Collections.IEnumerable elements = new DslModeling::ModelElement[] { property.Entity };
                UpdateCompartments(elements, typeof(global::FourDeep.PDizzle.EntityShape), "Properties", false);
            }

            if (property.View != null)
            {
                global::System.Collections.IEnumerable elements = new DslModeling::ModelElement[] { property.View };
                UpdateCompartments(elements, typeof(global::FourDeep.PDizzle.ViewShape), "Properties", false);
            }
        }
