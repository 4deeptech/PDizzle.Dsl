...
namespace FourDeep.PDizzle
{
	...
	/// </remarks>
	public partial class PDizzleHelpKeywordHelper : PDizzleHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new PDizzleHelpKeywordHelper.
		/// </summary>
		protected PDizzleHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the PDizzleHelpKeywordHelper.
		/// </summary>
		public static PDizzleHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class PDizzleHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new PDizzleHelpKeywordHelperBase.
		/// </summary>
		protected PDizzleHelpKeywordHelperBase()
			: base() { }
