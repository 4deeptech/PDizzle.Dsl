...
namespace FourDeep.PDizzle
{
	...
	/// </summary>
	internal partial class PDizzleDocView : PDizzleDocViewBase
	{
		/// <summary>
		/// Constructs a new PDizzleDocView.
		/// </summary>
		public PDizzleDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class PDizzleDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new PDizzleDocView.
		/// </summary>
		protected PDizzleDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			PDizzleDocDataBase docData = this.DocData as PDizzleDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for PDizzleDocViewBase should be an PDizzleDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::FourDeep.PDizzle.PDizzleDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::FourDeep.PDizzle.PDizzleDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::FourDeep.PDizzle.PDizzleToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::FourDeep.PDizzle.PDizzleToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.PDizzleDiagramMenu;
			}
		}
			...
			if(global::FourDeep.PDizzle.PDizzleHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::FourDeep.PDizzle.PDizzleHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
