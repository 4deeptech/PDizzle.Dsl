...
namespace FourDeep.PDizzle
{
	...
	/// </summary>
	internal partial class PDizzleCommandSet : PDizzleCommandSetBase
	{
		/// <summary>
		/// Constructs a new PDizzleCommandSet.
		/// </summary>
		public PDizzleCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class PDizzleCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new PDizzleCommandSetBase.
		/// </summary>
		protected PDizzleCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewPDizzleExplorerCommand,
				typeof(PDizzleEditorFactory).GUID);
		...
		{
			PDizzleExplorerToolWindow explorer = this.PDizzleExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected PDizzleDocData CurrentPDizzleDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as PDizzleDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected PDizzleDocView CurrentPDizzleDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as PDizzleDocView;
			}
		}
		...
		/// </summary>
		protected PDizzleExplorerToolWindow PDizzleExplorerToolWindow
		{
			get
			{
				PDizzleExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(PDizzleExplorerToolWindow), true) as PDizzleExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				PDizzleExplorerToolWindow explorerWindow = this.PDizzleExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class PDizzleClipboardCommandSet : PDizzleClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new PDizzleClipboardCommandSet.
		/// </summary>
		public PDizzleClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class PDizzleClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new PDizzleClipboardCommandSetBase.
		/// </summary>
		protected PDizzleClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
